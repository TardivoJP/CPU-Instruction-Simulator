...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Simulador de Instrucoes")
        ...
        ## Application Header
        title_label = QLabel("<h1>Simulador de Instrucoes</h1>")
    ...
    def show_manual_input_screen(self):
        self.input_widget = ManualInputScreen(self.show_welcome_screen, self.show_alert_box, self.center_on_screen)
    ...
    def show_file_input_screen(self):
        self.input_widget = FileInputScreen(self.show_welcome_screen, self.show_alert_box, self.center_on_screen)
        self.stacked_layout.addWidget(self.input_widget)
        self.stacked_layout.setCurrentWidget(self.input_widget)
